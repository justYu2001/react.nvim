                        ...
                        action = function()
                            ...
                            vim.ui.select({
                                ...
                                local import_edit = event_type
                                    and imports.create_type_import_edit(params.bufnr, event_type)
...
M.apply_handler_and_rename = apply_handler_and_rename
M.get_react_import_info = imports.get_react_import_info
M.has_type_import = imports.has_type_import
M.create_type_import_edit = imports.create_type_import_edit
